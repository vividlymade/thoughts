<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <path fill="currentColor" d="M11.5,11A2.5,2.5,0,1,0,14,13.5,2.48,2.48,0,0,0,11.5,11Z"/>
    <path fill="currentColor" d="M20.5,11A2.5,2.5,0,1,0,23,13.5,2.48,2.48,0,0,0,20.5,11Z"/>
